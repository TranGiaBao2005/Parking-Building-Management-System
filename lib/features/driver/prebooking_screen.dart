        ...
        builder: (context) {
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Text(
                        () {
                          final hours =
                              _exitTime.difference(_entryTime).inMinutes / 60.0;
          ...
          return Row(
            children: [
              ...
              Expanded(flex: 2, child: bookingsPanel),
            ],
          );
        },
      ),
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _BookRow('Loại xe',
                    '${booking.vehicleType.icon} ${booking.vehicleType.label}'),
          ...
          if (bookings.isEmpty)
            const Center(
              child: Padding(
                ...
                child: Text('Chưa có đặt chỗ nào.',
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                        '${dtFmt.format(b.expectedEntry)} → ${DateFormat("HH:mm").format(b.expectedExit)}',
                        style: const TextStyle(
