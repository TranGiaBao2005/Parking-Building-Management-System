...
class _CheckInScreenState extends State<CheckInScreen> {
  ...
  Widget _buildForm(BuildContext context, MockDataService svc, int available, int total) {
    return Padding(
  ...
  Widget _buildFormContent(BuildContext context, MockDataService svc, int available, int total) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text('Xe vào (Check-in)', style: Theme.of(context).textTheme.displayMedium)
            .animate().fadeIn(),
        ...
        TextField(
          ...
          style: const TextStyle(color: AppColors.textPrimary, fontSize: 20, fontWeight: FontWeight.bold, letterSpacing: 2),
              ...
              child: Padding(
                ...
                child: GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected ? const Color(0xFF10B981).withOpacity(0.15) : AppColors.surface,
                      borderRadius: BorderRadius.circular(12),
                      border: Border.all(
        ...
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: available > 0 ? AppColors.available.withOpacity(0.3) : AppColors.occupied.withOpacity(0.3),
            ),
          ),
          child: Row(
            children: [
        ...
        SizedBox(
          ...
          child: ElevatedButton.icon(
            ...
            label: const Text('Tạo lượt gửi xe', style: TextStyle(fontSize: 16)),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.login, color: AppColors.textMuted, size: 36),
          ),
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Check-in thành công!',
              style: Theme.of(context).textTheme.titleLarge?.copyWith(color: Color(0xFF10B981))),
          const SizedBox(height: 24),
          // QR code
          Container(
            ...
            child: QrImageView(
              data: 'SESSION:${session.id}|${session.licensePlate}|${session.slotCode}',
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                _InfoRow2('Loại xe', '${session.vehicleType.icon} ${session.vehicleType.label}'),
                _InfoRow2('Slot được cấp', session.slotCode),
                _InfoRow2('Giờ vào', dtFmt.format(session.entryTime)),
                _InfoRow2('Mã session', session.id.substring(0, 8).toUpperCase()),
              ],
            ),
          ),
          const SizedBox(height: 16),
